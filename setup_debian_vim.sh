...
if [ $vim_python_flag -eq 0 ];then
    wget https://raw.githubusercontent.com/JeffXue/common_scripts/master/install_python2.7.sh
    chmod +x install_python2.7.sh
    ./install_python2.7.sh  

    wget https://raw.githubusercontent.com/JeffXue/common_scripts/master/install_vim7.4.sh
